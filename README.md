...
For detailed documentation on specific features, refer to the following documents:

- [Spotify Authentication](./docs/spotify-authentication.md): Complete documentation of the Spotify authentication implementation, including the automatic token refresh mechanism that extends the standard 1-hour auth session.
